        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                <div class="login-container text-center">
                    ...
                    <div class="card-body">
                        <form action="${pageContext.request.contextPath}/Admin/AdminMedicine" method="post">
                            ...
                            <button type="submit" class="btn btn-success mt-3">Save Prescription</button>
                            <button type="reset" class="btn btn-danger mt-3">Clear Form</button>
                        </form>
                        
                <div class="mt-3">
                    <a href="Admin_Medicine_Up.jsp" class="btn btn-custom btn-block"><i class="fa-solid fa-pen"></i> Update</a>
                    <a href="Admin_Medicine_Del.jsp" class="btn btn-custom btn-block"><i class="fa-solid fa-trash"></i> Delete</a>
                </div>
                    </div>
                </div>
            </div>
